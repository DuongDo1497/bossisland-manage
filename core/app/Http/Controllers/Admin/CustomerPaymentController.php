...
class CustomerPaymentController extends Controller
{
    public function index($id)
    {
        ...
        if (request()->print) {
            ...
            return downloadPDF('pdf.customer.payments', compact('pageTitle', 'sales', 'customer'));
        }
        $pdfButton = true;
        return view('admin.payment.customer.list', compact('pageTitle', 'sales', 'customer', 'pdfButton'));
    }
