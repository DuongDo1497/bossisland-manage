...
class PurchaseReturnController extends Controller
{
    public function index()
    {
        ...
        $purchaseReturn = $purchaseReturn->paginate(getPaginate());
        $pdfButton = true;
        return view('admin.purchase_return.index', compact('pageTitle', 'purchaseReturn', 'pdfButton'));
    }
