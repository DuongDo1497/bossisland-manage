...
class SupplierPaymentController extends Controller
{
    public function index($id)
    {
        ...
        if (request()->print) {
            $pageTitle = 'Unsettled Payments';
            return downloadPDF('pdf.supplier.payments', compact('pageTitle', 'purchases', 'supplier'));
        }

        $pdfButton = true;
        return view('admin.payment.supplier.list', compact('pageTitle', 'purchases', 'supplier', 'pdfButton'));
    }
