                                ...
                                @forelse($paymentLogs as $log)
                                    <tr>
                                        ...
                                        <td class="fw-bold">
                                            ...
                                            @else
                                                <span class="text--danger"> {{ @$log->purchaseReturn->purchase->invoice_no }}</span>
                                            @endif
                                        </td>
        ...
        <div class="input-group w-auto">
            <select name="remark" class="form-control">
                ...
                @foreach ($remarks as $remark)
                    <option value="{{ $remark }}" @selected($remark == request()->remark)>{{ ucwords(strtolower(keyToTitle($remark))) }}</option>
                @endforeach
            </select>
