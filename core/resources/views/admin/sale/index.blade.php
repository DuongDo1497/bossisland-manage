                                ...
                                @forelse($sales as $sale)
                                    <tr>
                                        <td>
                                            ...
                                            <br>
                                            <em>{{ showDateTime($sale->sale_date, 'd M, Y') }}</em>
                                        </td>
                                        ...
                                        <td>
                                            {{ $sale->warehouse->name }}
                                            <br>
                                            <span class="fw-bold">{{ $general->cur_sym . showAmount($sale->total_price) }}</span>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <br>
                                            <span @if ($sale->due_amount < 0) class="text--danger" title="@lang('Give Payment To Customer')" @endif class="fw-bold">
                                        ...
                                        <td>
                                            <div class="button--group">
                                                ...
                                                <a href="{{ route('admin.sale.edit', $sale->id) }}" class="btn btn-sm btn-outline--primary ms-1">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a href="javascript:void(0)" class="dropdown-item paymentModalBtn" data-customer_id="{{ $sale->customer_id }}" data-customer="{{ $sale->customer->name }}" data-invoice="{{ $sale->invoice_no }}" data-id="{{ $sale->id }}" data-due_amount="{{ $sale->due_amount }}">
                                                    ...
                                                    @if ($sale->return_status == 0 && $sale->due_amount > 0)
                                                        <li>
                                                            <a href="{{ route('admin.sale.return.items', $sale->id) }}" class="dropdown-item">
                                                    ...
                                                    @if ($sale->return_status)
                                                        <li>
                                                            <a href="{{ route('admin.sale.return.edit', $sale->saleReturn->id) }}" class="dropdown-item editBtn">
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item" href="{{ route('admin.sale.pdf', $sale->id) }}/?print=true">
