                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                ...
                                                <button type="button" class="btn btn-sm btn-outline-danger @if ($category->products_count) disabled @endif confirmationBtn" data-question="@lang('Are you sure to delete this category?')" data-action="{{ route('admin.product.category.delete', $category->id) }}">
