                                ...
                                @forelse($purchaseReturn as $return)
                                    <tr>
                                        <td>
                                            ...
                                            <br>
                                            <em>{{ showDateTime($return->return_date, 'd M, Y') }}</em>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <br>
                                            <span class="fw-bold">{{ $general->cur_sym . showAmount($return->total_price) }}</span>
                                        </td>

                                        <td>
                                            {{ $general->cur_sym . showAmount($return->discount_amount) }}
                                            <br>
                                            <span class="fw-bold">{{ $general->cur_sym . showAmount($return->receivable_amount) }}</span>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <div class="button--group">
                                                <a href="{{ route('admin.purchase.return.edit', $return->id) }}" class="btn btn-sm btn-outline--primary ms-1 editBtn"><i class="las la-pen"></i> @lang('Edit')
                                                </a>
                                                ...
                                                <div class="dropdown-menu">
                                                    ...
                                                    @if ($return->due_amount != 0)
                                                        <a href="javascript:void(0)" class="dropdown-item paymentModalBtn" data-supplier="{{ $return->supplier->name }}" data-invoice="{{ $return->purchase->invoice_no }}" data-id="{{ $return->id }}" data-due_amount="{{ $return->due_amount }}">
                                                            @if ($return->due_amount < 0)
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item" href="{{ route('admin.purchase.return.pdf', $return->id) }}/?print=true">
